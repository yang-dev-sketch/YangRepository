        ...
        {(CommonUtils.isBeforeToday(data.date) && (
          <VerticalLayout style={styles.active_item}>
            ...
            <HorizontalLayout
              ...
              <Text style={{ fontSize: 14, lineHeight: 22, color: '#1E6FD9', fontWeight: '600', fontFamily: 'Danidin' }}>
                {CommonUtils.getFormatedDate(data.date, 'hh:mm')}
              </Text>
              <HorizontalLayout>
                <VerticalLayout>
                  <Text style={{ fontSize: 16, lineHeight: 19, color: '#000', fontWeight: '600', fontFamily: 'Danidin' }}>{data.task}</Text>
                  <Text
                    style={{
                      fontSize: 14,
                      lineHeight: 22,
            ...
            <VerticalLayout style={{ paddingVertical: 10, paddingHorizontal: 15 }}>
              <Text style={{ fontSize: 14, lineHeight: 17, marginBottom: 8, color: '#000', fontFamily: 'Danidin' }}>
          ...
          <HorizontalLayout style={styles.noti_item}>
            <VerticalLayout style={{ alignItems: 'space-between', justifyContent: 'flex-end' }}>
              ...
              <Text numberOfLines={1} style={{ fontSize: 14, lineHeight: 22, color: '#979797', fontFamily: 'Danidin' }}>
                {CommonUtils.getFormatedDate(data.date, 'hh:mm, DD.MM.YYYY')}
              </Text>
            </VerticalLayout>
            <LocalImage
